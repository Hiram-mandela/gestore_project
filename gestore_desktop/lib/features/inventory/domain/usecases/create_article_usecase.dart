...
// VERSION 3.0 - Support multi-images avec fichiers
// ========================================
...
class CreateArticleParams {
  ...
  // ⭐ SECTION 6 : IMAGES (NOUVEAU SYSTÈME)
  final String? primaryImagePath; // Chemin local de l'image principale
  final List<String>? secondaryImagePaths; // Chemins locaux des images secondaires

  // DONNÉES COMPLEXES (métadonnées)
...
class CreateArticleUseCase implements UseCase<ArticleDetailEntity, CreateArticleParams> {
  ...
  Future<(ArticleDetailEntity?, String?)> call(CreateArticleParams params) async {
    ...
    // ⭐ Appel repository avec les 3 paramètres incluant les images secondaires
